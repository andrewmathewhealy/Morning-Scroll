...
const WEATHER_MAP = {
  'clear-day':             { label: 'Clear Skies',         icon: () => AnimSun,            bg: 'linear-gradient(135deg, #c47a20 0%, #e8a840 40%, #f5c862 100%)', effect: 'sunny', tone: 'night', image: '/weather/clear-day.webp' },
  'clear-night':           { label: 'Clear Night',         icon: () => AnimMoon,           bg: 'linear-gradient(135deg, #081020 0%, #0C1A35 50%, #142848 100%)', effect: 'stars', tone: 'night', image: '/weather/clear-day.webp', overlay: 'rgba(12,26,53,0.55)' },
  'partly-cloudy-day':     { label: 'Partly Cloudy',       icon: () => AnimCloud,          bg: 'linear-gradient(135deg, #4a7a9a 0%, #7a9ab0 50%, #c4a35a 100%)', effect: 'sunny', tone: 'night', image: '/weather/partly-cloudy-day.webp' },
  'partly-cloudy-night':   { label: 'Partly Cloudy Night', icon: () => AnimCloud,          bg: 'linear-gradient(135deg, #0C1A35 0%, #1a3255 50%, #2a4a7a 100%)', effect: 'stars', tone: 'night', image: '/weather/partly-cloudy-day.webp', overlay: 'rgba(12,26,53,0.55)' },
  'cloudy':                { label: 'Overcast',            icon: () => AnimCloud,          bg: 'linear-gradient(135deg, #3a4a5a 0%, #5a6a78 50%, #7a8890 100%)', effect: null, tone: 'night', image: '/weather/overcast.webp', overlay: 'rgba(80,80,80,0.4)' },
  'fog':                   { label: 'Foggy',               icon: () => AnimWind,           bg: 'linear-gradient(135deg, #4a5568 0%, #718096 50%, #a0aec0 100%)', effect: null, tone: 'night', image: '/weather/overcast.webp', overlay: 'rgba(80,80,80,0.5)' },
  'wind':                  { label: 'Windy',               icon: () => AnimWind,           bg: 'linear-gradient(135deg, #2d4a6e 0%, #4a7a9b 50%, #7fb3cc 100%)', effect: null, tone: 'night', image: '/weather/overcast.webp', overlay: 'rgba(80,80,80,0.35)' },
  'rain':                  { label: 'Rainy',               icon: () => AnimCloudRain,      bg: 'linear-gradient(135deg, #1a2535 0%, #2a3d55 50%, #3a5570 100%)', effect: 'rain', tone: 'night', image: '/weather/rain.webp' },
  'showers-day':           { label: 'Rain Showers',        icon: () => AnimCloudRain,      bg: 'linear-gradient(135deg, #1e3a5f 0%, #2d5a7a 50%, #5a8fa8 100%)', effect: 'rain', tone: 'night', image: '/weather/rain.webp' },
  'showers-night':         { label: 'Overnight Showers',   icon: () => AnimCloudRain,      bg: 'linear-gradient(135deg, #0d1f35 0%, #1a3050 50%, #2d4f6e 100%)', effect: 'rain', tone: 'night', image: '/weather/rain.webp', overlay: 'rgba(12,26,53,0.4)' },
  'thunder-rain':          { label: 'Thunderstorms',       icon: () => AnimCloudLightning, bg: 'linear-gradient(135deg, #0d0d1f 0%, #16213e 50%, #0f3460 100%)', effect: 'rain', tone: 'night', image: '/weather/stormy.webp', overlay: 'rgba(80,80,80,0.4)' },
  'thunder-showers-day':   { label: 'Stormy',              icon: () => AnimCloudLightning, bg: 'linear-gradient(135deg, #1a1a2e 0%, #2d2d4e 50%, #4a3a6e 100%)', effect: 'rain', tone: 'night', image: '/weather/stormy.webp', overlay: 'rgba(80,80,80,0.4)' },
  'thunder-showers-night': { label: 'Stormy Night',        icon: () => AnimCloudLightning, bg: 'linear-gradient(135deg, #0d0d1f 0%, #1a1a35 50%, #2d2040 100%)', effect: 'rain', tone: 'night', image: '/weather/stormy.webp', overlay: 'rgba(12,26,53,0.55)' },
  'snow':                  { label: 'Snowing',             icon: () => AnimCloudSnow,      bg: 'linear-gradient(135deg, #c8dce8 0%, #a0b8cc 50%, #7a98b0 100%)', effect: 'snow', tone: 'night', image: '/weather/snow.webp' },
  'snow-showers-day':      { label: 'Snow Showers',        icon: () => AnimCloudSnow,      bg: 'linear-gradient(135deg, #b0c8d8 0%, #8aa8c0 50%, #6a8aa5 100%)', effect: 'snow', tone: 'night', image: '/weather/snow.webp' },
  'snow-showers-night':    { label: 'Overnight Snow',      icon: () => AnimCloudSnow,      bg: 'linear-gradient(135deg, #0d1a2e 0%, #1a2e45 50%, #3a5570 100%)', effect: 'snow', tone: 'night', image: '/weather/snow.webp', overlay: 'rgba(12,26,53,0.4)' },
  'sleet':                 { label: 'Sleet',               icon: () => AnimCloudSnow,      bg: 'linear-gradient(135deg, #2a3d55 0%, #455e75 50%, #7a9ab0 100%)', effect: 'snow', tone: 'night', image: '/weather/snow.webp' },
  'hail':                  { label: 'Hail',                icon: () => AnimCloudSnow,      bg: 'linear-gradient(135deg, #1f3040 0%, #354f65 50%, #6a8fa8 100%)', effect: 'snow', tone: 'night', image: '/weather/snow.webp' },
  'tornado':               { label: 'Tornado Warning',     icon: () => AnimWind,           bg: 'linear-gradient(135deg, #1a0a0a 0%, #3d1515 50%, #6e2020 100%)', effect: null, tone: 'night', image: '/weather/stormy.webp', overlay: 'rgba(80,80,80,0.5)' },
  'drizzle':               { label: 'Light Drizzle',       icon: () => AnimCloudDrizzle,   bg: 'linear-gradient(135deg, #243b55 0%, #3d5c78 50%, #6a8fa8 100%)', effect: 'drizzle', tone: 'night', image: '/weather/rain.webp' },
  'freezing-drizzle':      { label: 'Freezing Drizzle',    icon: () => AnimCloudDrizzle,   bg: 'linear-gradient(135deg, #1e3040 0%, #304f65 50%, #6080a0 100%)', effect: 'drizzle', tone: 'night', image: '/weather/rain.webp' },
  'freezing-rain':         { label: 'Freezing Rain',       icon: () => AnimCloudRain,      bg: 'linear-gradient(135deg, #1a2535 0%, #2d4055 50%, #4a6a85 100%)', effect: 'rain', tone: 'night', image: '/weather/rain.webp' },
};
